...
export default function Home() {
  ...
  const handleSearch = async () => {
    try {
      ...
      navigate('/service/list', { state: { services: searchResults }});
    } catch (error) {
      console.error('Error occurred during search:', error);
    }
    ...
    <div className='mt-20 max-w-screen '>
      ...
      <div className='flex justify-center  items-center min-h-screen '>
        ...
        <div className='mx-2 relative'>
          ...
          <div className='bg-white sm:grid-cols-2 rounded-md grid grid-cols-1 gap-6 justify-items-center lg:flex justify-between p-5 items-center'>
      ...
      <div  className='mx-auto my-16 container'>
        <div className='text-center'>
          ...
          <div>
              <div className='grid  w-full sm:grid-cols-2 lg:grid-cols-3 my-8 mx-auto gap-2 justify-items-center '>
                ...
                <Link key={index} to={`/service/list?category=${encodeURIComponent(count.category)}`} className='count sm:inline-block outline-none my-4 p-10 shadow-inner hover:bg-[#f3f5f7] cursor-pointer transition-all duration-300 ease-in-out border rounded-md lg:mx-10 h-64 w-56'>
        ...
        <div className='bg-[#f3f5f7] py-5'>
          <div className='text-center  container mx-auto'>
            ...
            <div className='grid grid-cols-1 lg:w-[100%] xl:w-[85%] mx-auto p-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center text-justify'>

            {bestServices.map((service) => (
              
              <div className=" bg-white rounded w-full  lg:w-[85%] shadow-lg">
                ...
                <div className="px-3 flex flex-col justify-items-center py-5 relative mx-2 my-1">
